...
public class ConnectionTest extends BaseTestCase {
     ...
     *
     * This test uses a StatementInterceptor to capture the query sent to the
     * server and assert whether escape processing has been done in the client
     * side or if the query is sent untouched and escape processing will be done
     * at server side, according to provided connection properties and type of
     ...
     * testsuite/ssl-test-certs. The server needs to be configured with the CA
     * and server certificates from testsuite/ssl-test-certs.
     */
