...
/**
 * @todo this hash sharding test is incompatible with the default Fabric
 * configuration for these C/J Fabric tests.
 */
public class TestHashSharding extends BaseFabricTestCase {
    ...
    /**
     * Check data used by basic tests is in proper groups. Test both by direct
     * group selection and shard table/key selection.
     */
