...
public class TestFabricMySQLConnectionSharding extends BaseFabricTestCase {
    ...
    /**
     * Test that we can create a table in the global group and see it in other
     * groups.
     */
    ...
    /**
     * Test that sharding works by creating data in two shards and making sure
     * it's only visible in the respective server group.
     */
    ...
    /**
     * Test that providing the query table(s) to the connection chooses the
     * proper shard mapping/table.
     */
