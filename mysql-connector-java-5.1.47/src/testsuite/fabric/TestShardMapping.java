...
public class TestShardMapping extends TestCase {
    ...
    /**
     * Tests fix for Bug#82203 - com.mysql.fabric.HashShardMapping is not thread
     * safe.
     *
     * This test is non-deterministic but most runs used to fail before 5 to 10
     * seconds. This test runs at most for 30 seconds.
     */
