...
public class Util {
     ...
     * There is no need to call Extension.init() method after that if you don't
     * change connection or properties.
     *
     * @param conn
     * @param props
     ...
     * implements a java.sql, javax.sql or com.mysql.jdbc interface.
     *
