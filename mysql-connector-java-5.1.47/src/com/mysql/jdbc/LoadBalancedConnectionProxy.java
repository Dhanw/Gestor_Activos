...
/**
 * A proxy for a dynamic com.mysql.jdbc.Connection implementation that load
 * balances requests across a series of MySQL JDBC connections, where the
...
public class LoadBalancedConnectionProxy extends MultiHostConnectionProxy implements PingTarget {
     ...
     * @param props Connection properties from where to get initial settings and
     ...
     * be used as a replacement of the <code>null</null> keyword in the places
     * where a LoadBalancedConnection object cannot be effectively
     * <code>null</code> because that would be a potential source of NPEs.
     */
