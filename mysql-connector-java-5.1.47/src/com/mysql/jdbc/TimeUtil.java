...
public class TimeUtil {
     ...
     * @param serverSupportsFracSecs flag indicating does server support
     * fractional seconds
     ...
     * Applied only to GregorianCalendar parameters.
     *
     * @param origCalendar original Calendar
     * @param refCalendar reference Calendar
     * @return the original Calendar if no adjustments are needed or the new
     * proleptic GregorianCalendar with preserved Timezone of origCalendar and
     * other fields unset.
     */
