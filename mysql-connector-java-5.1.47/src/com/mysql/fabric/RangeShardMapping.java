...
public class RangeShardMapping extends ShardMapping {
    ...
    /**
     * A sorter that sorts shard indices from highest to lowest based on the
     * integer value of their bounds. For a range shard mapping, the bound is a
     * lowest bound.
     */
    ...
    /**
     * Search through the shard indicies to find the shard holding this key.
     * Range-based sharding defines a lower bound for each partition with the
     * upper bound being one less than the lower bound of the next highest
     * shard. There is no upper bound for the shard with the highest lower
     * bound.
     */
    @Override
