...
public class XmlRpcClient {
     ...
     *
     * @throws FabricCommunicationException If comm fails or the server reports
    ...
    /**
     * Retrieve a set of complete shard mappings. The returned mappings include
     * all information available about the mapping.
     *
