...
public class DigestAuthentication {
    ...
    /**
     * Get the digest challenge header by connecting to the resource with no
     * credentials.
     */
    ...
    /**
     * Serialize a parameter map into a digest response. This is used as the
     * "Authorization" header in the request. All parameters in the supplied map
    ...
    /**
     * Parse a digest challenge from the WWW-Authenticate header return as the
     * initial response during the authentication exchange.
     */
    ...
    /**
     * Generate the cnonce value. This allows the client provide a value used in
     * the digest calculation. Same as Python. (no motivation given for this
     * algorithm)
     */
    ...
    /**
     * Quote a parameter to be included in the header. Parameters with embedded
     * quotes will be rejected.
     */
    ...
    /**
     * Generate the Authorization header to make the authenticated request.
     */
