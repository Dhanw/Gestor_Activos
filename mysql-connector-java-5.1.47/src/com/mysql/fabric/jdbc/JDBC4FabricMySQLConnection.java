...
public interface JDBC4FabricMySQLConnection extends com.mysql.jdbc.JDBC4MySQLConnection {
    ...
    /**
     * Clear all the state that is used to determine which server to send
     * queries to.
     */
    ...
    /**
     * Set the table being accessed. Can be a table name or a "database.table"
     * pair. The table must be known by Fabric as a sharded table.
     */
    ...
    /**
     * Set the server group name to connect to. Direct server group selection is
     * mutually exclusive of sharded data access.
     */
    ...
    /**
     * Clear the list of tables for the last query. This also clears the shard
     * mapping/table and must be given again for the next query via
     * {@link setShardTable} or {
     *
     * @addQueryTable}.
     */
