...
public class FabricMySQLConnectionProxy extends ConnectionPropertiesImpl implements FabricMySQLConnection, FabricMySQLConnectionProperties {
    ...
    /**
     * Deal with an exception thrown on an underlying connection. We only
     * consider connection exceptions (SQL State 08xxx). We internally handle a
     * possible failover situation.
     *
     * @param sqlEx
     * @param conn
     * @param group
    ...
    /**
     * Add a table to the set of tables used for the next query on this
    ...
    //////////////////////////////////////////////////////
    /**
     * Get the active connection as an object implementing the internal
     * MySQLConnection interface. This should not be used unless a
     * MySQLConnection is required.
     *
     * {@link getActiveConnection()} is provided for the general case. The
     * returned object is not a {@link ReplicationConnection}, but instead the
     * {@link LoadBalancedConnectionProxy} for either the master or slaves.
     */
    ...
    /**
     * Sync the state of the current group's servers to that of the given
     * replication connection group. This is necessary as:
     * <ul>
     * <li>New connections have updated state from the Fabric server</li>
     * <li>Failover scenarios may update state and it should be propagated
     * across the active connections</li>
     * </ul>
     */
    ...
    /**
     * Close this connection proxy which entails closing all open connections to
     * MySQL servers.
     */
    ...
    /**
     * Only valid until the end of the transaction. These could optionally be
     * implemented to only return true if all current connections return true.
     */
     ...
     * <code>getEncodingForIndex(int charsetIndex)</code>
     */
    @Deprecated
